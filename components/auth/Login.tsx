"use client"
import { Eye, EyeOff, Mail, ShoppingBagIcon } from 'lucide-react'
...
import { decodeUser, getMe, login } from '@/lib/api/auth'
    ...
    >
      <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
        ...
        <div className="mt-4 text-center">
          <h2 className="text-2xl font-bold mb-2">Hello, welcome back!</h2>
        ...
        <p className="text-center text-gray-500 mt-6 text-sm">
          ...
          <Link href="/register" className="text-indigo-600 font-semibold hover:text-indigo-500 transition">
